...
var apiKey = File.ReadAllText("C:\\Users\\Asus\\Desktop\\OpenAIApiKey.txt");
...
await File.WriteAllTextAsync("C:\\Users\\Asus\\Desktop\\WhisperResponse.srt", transcription, cts.Token);
...
var completionResult = await openAiService.ChatCompletion.CreateCompletion(new ChatCompletionCreateRequest
{
    ...
    {
        ChatMessage.FromSystem($"You are a helpful translator from English to {language}. " +
                               $"You've worked as a translator your whole life and are very good at it. Don't include any extra explanations in your responses!"),

        ChatMessage.FromUser($"Could you please translate the text given below to {language}. " +
                             $"The text is a \".srt\" file. Therefore, do not change the time values! If I like your suggestions, I'll tip you $5000 for your help.\n{transcription}"),
    },
    Model = Models.Gpt_4o,
});
...
if (completionResult.Successful)
{
    ...
    await File.WriteAllTextAsync("C:\\Users\\Asus\\Desktop\\WhisperResponse.tr-TR.srt", turkishTranscription, cts.Token);
}